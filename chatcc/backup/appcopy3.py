...
def chat():
    try:
        ...
        # Determine if the user needs a follow-up or if they want to ask something else
        response = get_response(ints, intents, user_id)

        # Add follow-up question based on the response
        ...
        full_response = f"{sentiment_response} {response} {follow_up_question}"
